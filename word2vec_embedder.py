...
class word2vec_embedder:
    ...
    def getAvgFeatureVecs(reviews, num_features):
        ...
        for review in reviews:
           ...
           reviewFeatureVecs[int(counter)] = makeFeatureVec(review,num_features)
           # 카운터를 증가시킨다.
           counter = counter + 1.
...
# trainDataVecs = getAvgFeatureVecs(train_sentences, num_features)
# testDataVecs = getAvgFeatureVecs(test_sentences, num_features)
